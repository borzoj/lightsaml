...
class Assertion implements GetXmlInterface, LoadFromXmlInterface
{
    ...
    function getXml(\DOMNode $parent, SerializationContext $context) {
        ...
        if ($this->getValidAudience()) {
            $audienceRestrictionNode = $context->getDocument()->createElementNS(Protocol::NS_ASSERTION, 'saml:AudienceRestriction');
            $conditionsNode->appendChild($audienceRestrictionNode);
            foreach ($this->getValidAudience() as $v) {
                $audienceNode = $context->getDocument()->createElementNS(Protocol::NS_ASSERTION, 'saml:Audience', $v);
